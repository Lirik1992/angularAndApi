(function () {
    ...
    angular.module('mainApp')
        .controller('HomeController', ['appData', 'homeService', '$scope', '$log', '$route', 'toaster', 'toasterService', 'weatherFactory', HomeController]);

    function HomeController(appData, homeService, $scope, $log, $route, toaster, toasterService, weatherFactory) {
        var vm = this;
        ...
        weatherFactory.getCurrentWeather('Moscow')
            .then(getWeather, null)
            .catch(weatherError);
